...
\newcommand{\localfigdir}{../../assets/images/mathematical_model/mathematical_model}
\newcommand{\projectfigdir}{../../../../assets/images/mathematical_model/mathematical_model}
...
\begin{figure}[!ht]
    ...
    $$
    \!\!\!\!\!\!\!\!\!\!\!\!\!\!\!\!\!\!\!\!
\includegraphics[scale=0.28]{../../assets/images/mathematical_model/Ctimes.png}
    $$
    \vskip -.5cm
    \caption{[...]}
    \label{fig:Ctimes}
...
\begin{figure}[!ht]
    \vskip -.5cm
    $$
    \includegraphics[scale=0.28]{../../assets/images/mathematical_model/Qptimes.png}
    $$
    \vskip -.5cm
    \caption{[...]}
    \label{fig:Qptimes}
