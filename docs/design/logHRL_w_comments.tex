...
For residual correction, it is {\em multigrid}-like, in the sense of \cite{AhamedZakariaeiHaberEliasofMGE2026}. MgNet \textcolor{red}{Do you mean this \cite{he2019mgnet} article?} {\color{blue} Ok yeah I'm a little lost... Does the 2026 paper use a framework developed in the 2019 paper? My understanding is the both introduce a kind of gradient scaling between successive tiers of the U-Net, and uses these scaling factors to say mroe concrete things about the computational efficiency of the U-Net. Let's investigate this more carefully.} makes this correspondence especially explicit: restriction maps pass information to a coarser grid, smoothing operations remove local high-frequency error, and prolongation maps lift coarse corrections back to the fine scale. Read through this lens, a residual CNN is not merely a stack of feature extractors; it is also an iterative correction scheme in which coarse representations control the search for fine-scale residual structure.
...
\textcolor{red}{I would maybe use a breakable algorithm} {\color{blue} Can you explain?}
\begin{ermark}
